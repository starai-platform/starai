...
export const UI_TRANSLATION_KEYS = [
  ...
  "agent.detailPage.completed",
  "agent.detailPage.composeSkipped",
  "agent.detailPage.downloadLong",
  "agent.detailPage.finalLong",
  "agent.detailPage.longReady",
  "agent.detailPage.modules",
  "agent.detailPage.modulesReady",
  "agent.detailPage.title",
  "agent.plan",
  "agent.scene",
