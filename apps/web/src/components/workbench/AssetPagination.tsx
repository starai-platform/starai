...
export function AssetPagination({ page, total, loading, pageSize = 18, onChange }: {
  page: number; total: number; loading: boolean; pageSize?: number; onChange: (page: number) => void;
}) {
  const { td } = useI18n();
